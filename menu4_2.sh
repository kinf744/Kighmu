...
while true; do
    ...
    read -r choix
    case $choix in
        1|01) show_banner; read -p "Appuyez sur Entrée pour continuer..." ;;
        2|02) create_banner; read -p "Appuyez sur Entrée pour continuer..." ;;
        3|03) delete_banner; read -p "Appuyez sur Entrée pour continuer..." ;;
        0|00) break ;;
