...
ip link set dev "$interface" mtu 512 || log "Échec réglage MTU, continuer"
...
EOF
    ...
    echo ""
    echo "Le MTU du tunnel est fixé à 512 via le script de démarrage pour limiter la fragmentation DNS."
    echo ""
