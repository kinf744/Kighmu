...
# Les clients sont ajoutés via menu_6.sh create_config() avec email=username
# → l'email = username est indispensable pour que statsquery retourne des
#   données par utilisateur dans le panel
# ============================================================================
...
# Tous les inbounds démarrent avec clients vides — ajout via menu_6.sh (email=username)
