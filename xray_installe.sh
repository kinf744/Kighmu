...
# ============
# users.json — format TLS/NTLS par protocole (compatible menu_6.sh)
# ============
...
#   Trojan WS  TLS  → 127.0.0.1:25432  path /trojan-tls
...
#   Trojan WS  NTLS → 127.0.0.1:25433  path /trojan-ntls
#
...
server {
    ...
    location /trojan-tls { proxy_pass http://127.0.0.1:25432; proxy_http_version 1.1; proxy_set_header Upgrade \$http_upgrade; proxy_set_header Connection "upgrade"; proxy_set_header Host \$http_host; proxy_set_header X-Real-IP \$remote_addr; }
...
server {
    ...
    location /trojan-ntls { proxy_pass http://127.0.0.1:25433; proxy_http_version 1.1; proxy_set_header Upgrade \$http_upgrade; proxy_set_header Connection "upgrade"; proxy_set_header Host \$http_host; proxy_set_header X-Real-IP \$remote_addr; }
    location /ss-ws       { proxy_pass http://127.0.0.1:30300; proxy_http_version 1.1; proxy_set_header Upgrade \$http_upgrade; proxy_set_header Connection "upgrade"; proxy_set_header Host \$http_host; proxy_set_header X-Real-IP \$remote_addr; }
}
EOF
