#!/bin/bash
# Mod By NevermoreSSH
# Installation Xray minimaliste style NevermoreSSH avec Trojan WS
# =====================================================
  ...
  "inbounds": [
    {
      ...
      "streamSettings":{"network":"ws","security":"tls","tlsSettings":{"certificates":[{"certificateFile":"'"$path_crt"'","keyFile":"'"$path_key"'"}]},"wsSettings":{"path":"/vmess","headers":{"Host":""}}}
    },
    {
      "port": 89,
      "protocol": "vmess",
    ...
    },
    {
      ...
      "streamSettings":{"network":"ws","security":"tls","tlsSettings":{"certificates":[{"certificateFile":"'"$path_crt"'","keyFile":"'"$path_key"'"}]},"wsSettings":{"path":"/vless","headers":{"Host":""}}},
      "sniffing":{"enabled":true,"destOverride":["http","tls"]}
    },
    {
      "port": 89,
      ...
      "streamSettings":{"network":"ws","security":"none","wsSettings":{"path":"/vless","headers":{"Host":""}}},
      "sniffing":{"enabled":true,"destOverride":["http","tls"]}
    },
    {
      "port": 8443,
      ...
      "streamSettings":{"network":"ws","security":"tls","tlsSettings":{"certificates":[{"certificateFile":"'"$path_crt"'","keyFile":"'"$path_key"'"}]},"wsSettings":{"path":"/trojanws","headers":{"Host":""}}}
    },
    {
      "port": 89,
      "protocol": "trojan",
      "settings": {"clients":[{"password":"'"$uuid6"'"}]},
      "streamSettings":{"network":"ws","security":"none","wsSettings":{"path":"/trojanws","headers":{"Host":""}}}
    }
  ],
