  ...
  "inbounds": [
    {
      ...
      "streamSettings": {"network":"ws","security":"none","wsSettings":{"path":"/vmess-tls"}}
    },
    {
      "port": 10002,
      "protocol": "vmess",
      "settings": {"clients":[{"id":"$uuid2","alterId":0}]},
      "streamSettings": {"network":"ws","security":"none","wsSettings":{"path":"/vmess-ntls"}}
    },
    {
      "port": 10003,
      "protocol": "vless",
      "settings": {"clients":[{"id":"$uuid3"}],"decryption":"none"},
      "streamSettings": {"network":"ws","security":"none","wsSettings":{"path":"/vless-tls"}}
    },
    {
      "port": 10004,
      "protocol": "vless",
      "settings": {"clients":[{"id":"$uuid4"}],"decryption":"none"},
      "streamSettings": {"network":"ws","security":"none","wsSettings":{"path":"/vless-ntls"}}
    },
    {
      "port": 10005,
      "protocol": "trojan",
      "settings": {"clients":[{"password":"$uuid5"}]},
      "streamSettings": {"network":"ws","security":"none","wsSettings":{"path":"/trojan-tls"}}
    },
    {
      "port": 10006,
      "protocol": "trojan",
      "settings": {"clients":[{"password":"$uuid6"}]},
      "streamSettings": {"network":"ws","security":"none","wsSettings":{"path":"/trojan-ntls"}}
    },
    {
      "port": 10011,
      "protocol": "vmess",
    ...
    },
    {
      ...
      "protocol": "vmess",
      "settings": {"clients":[{"id":"$uuid1","alterId":0}]},
      "streamSettings": {"network":"grpc","security":"tls","tlsSettings":{"certificateFile":"/etc/xray/xray.crt","keyFile":"/etc/xray/xray.key"},"grpcSettings":{"serviceName":"vmess-grpc"}}
    },
    {
      "port": 10022,
      "protocol": "vless",
    ...
    },
    {
      ...
      "protocol": "trojan",
      "settings": {"clients":[{"password":"$uuid5"}]},
      "streamSettings": {"network":"grpc","security":"tls","tlsSettings":{"certificateFile":"/etc/xray/xray.crt","keyFile":"/etc/xray/xray.key"},"grpcSettings":{"serviceName":"trojan-grpc"}}
    }
  ],
