...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo "📲 𝘼𝙋𝙋𝙎 : HTTP Injector, CUSTOM, SOCKSIP TUNNEL, SSC ZIVPN, etc."
echo ""
echo -e "➡️ 𝙎𝙎𝙃 𝙒𝙎 : ${GREEN}$DOMAIN:80@$username:$password${RESET}"
echo -e "➡️ 𝙎𝙎𝙇/𝙏𝙇𝙎 : ${GREEN}$DOMAIN:444@$username:$password${RESET}"
echo -e "➡️ 𝙋𝙍𝙊𝙓𝙔 𝙒𝙎 : ${GREEN}$DOMAIN:9090@$username:$password${RESET}"
echo -e "➡️ 𝙎𝙎𝙃 𝙐𝘿𝙋 : ${GREEN}$DOMAIN:1-65535@$username:$password${RESET}"
echo ""
echo -e "📜 𝙋𝘼𝙔𝙇𝙊𝘼𝘿 𝙒𝙎:"
...
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
echo -e "🚀 ${BOLD}𝗛𝗬𝗦𝗧𝗘𝗥𝗜𝗔 𝗨𝗗𝗣 𝗧𝗨𝗡𝗡𝗘𝗟${RESET}"
echo -e "${GREEN}🌐 𝗗𝗼𝗺𝗮𝗶𝗻𝗲 : ${YELLOW}$DOMAIN${RESET}"
echo -e "${GREEN}👤 𝗢𝗯𝗳𝘀 : ${YELLOW}hysteria${RESET}"
echo -e "${GREEN}🔐 𝗣𝗮𝘀𝘀𝘄𝗼𝗿𝗱: ${YELLOW}$password${RESET}"
echo -e "${GREEN}🔌 𝐏𝐨𝐫𝐭 : ${YELLOW}20000-50000${RESET}"
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
